...
<body>
  ...
  <footer class="bg-dark text-white p-3 mt-4">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <span>View on GitHub <a href="https://github.com/<?= htmlspecialchars($github_user) ?>/<?= htmlspecialchars($repo) ?>" target="_blank" class="text-white"><?= htmlspecialchars($github_user) ?>/<?= htmlspecialchars($repo) ?></a></span>
    </div>
  </footer>
